...
| 2 | ✓ | AI 响应延迟 | avg ≤ 3s, max ≤ 5s | 2.00 ms | avg=2ms, max=4ms |
| 3 | ✓ | HTML 预览延迟 | avg ≤ 10s, max ≤ 15s | 1365.00 ms | avg=1365ms, max=4039ms |
| 4 | ✓ | 顾问带选项比例 | ≥ 90% | 1.00 ratio | 100.00% |
| 5 | ✓ | 模板匹配度 | 100% (builtin_business_dark) | 1.00 ratio | 100.00% template_id=builtin_business_dark |
| 6 | ✗ | voice 准确率 | avg ≥ 95% (mock 录音池) | 0.00 ratio | avg=0.00% min=0.00% pool_size=10 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 01 | ✗ | 0.0% | 2ms | 4039ms | 100.0% | 100.0% | 0.0% | 70MB | ✓ | ✓ |
| 02 | ✗ | 0.0% | 4ms | 30ms | 100.0% | 100.0% | 0.0% | 71MB | ✓ | ✓ |
| 03 | ✗ | 0.0% | 1ms | 26ms | 100.0% | 100.0% | 0.0% | 71MB | ✓ | ✓ |
...
|---|---|---|---|
| 文件导入成功率 | 57.14% | ≥ 99% | ✗ |
| AI 响应延迟 (avg / max) | 2ms / 4ms | ≤ 3000ms / 5000ms | ✓ |
| HTML 预览延迟 (avg / max) | 1365ms / 4039ms | ≤ 10000ms / 15000ms | ✓ |
| 顾问带选项比例 | 100.00% | ≥ 90% | ✓ |
| 模板匹配度 (builtin_business_dark) | 100.00% | 100% | ✓ |
| voice 准确率 (avg / min) | 0.00% / 0.00% | avg ≥ 95% | ✗ |
