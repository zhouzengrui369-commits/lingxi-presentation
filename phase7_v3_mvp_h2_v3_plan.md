...
- **产出物**:
  ...
  - **H2 重新定义 doc**: `docs/H2_THRESHOLD_REDEFINITION.md`
    ...
    - 提议: H2 → "AI 响应流式首 token 延迟 P50 ≤ 1.2s" (NJX 拍板前 PM 仅给候选, 不锁值)
...
- **验收信号**:
  ...
  - [ ] H2 新阈值真测: `node scripts/verify_h2_v3.mjs` 跑 10 次流式 demo, P50 ≤ 1.2s + P90 ≤ 3s (待 NJX 拍新阈值)
...
| NJX 拍 H2 新阈值 | P50/P90/P99 数值 NJX 拍定 | 弹窗 NJX |
